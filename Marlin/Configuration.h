...
#define STRING_CONFIG_H_AUTHOR "(mega_john@mail.ru)" // Who made the changes.
...
//john!!!
#define STRING_SPLASH_LINE3 "mega_john@mail.ru"
// #define CUSTOM_MACHINE_NAME "mega_john@mail.ru, marlin build "  __DATE__ " " __TIME__
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 64, 64, 64, 64 }
